...
|------------|-------------|-------|--------|
| [open-webui](https://github.com/open-webui/open-webui) | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) | 90597 | [@open-webui](https://github.com/open-webui) (open-webui) |
| [n8n](https://github.com/n8n-io/n8n) | Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations. | 84148 | [@n8n-io](https://github.com/n8n-io) (n8n-io) |
| [anything-llm](https://github.com/Mintplex-Labs/anything-llm) | The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more. | 43110 | [@Mintplex-Labs](https://github.com/Mintplex-Labs) (Mintplex-Labs) |
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | A collection of MCP servers. | 41085 | [@punkpeye](https://github.com/punkpeye) |
...
| [mastra](https://github.com/mastra-ai/mastra) | The TypeScript AI agent framework. ⚡ Assistants, RAG, observability. Supports any LLM: GPT-4, Claude, Gemini, Llama. | 12269 | [@mastra-ai](https://github.com/mastra-ai) (mastra-ai) |
| [UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop) | A GUI Agent application based on UI-TARS(Vision-Language Model) that allows you to control your computer using natural language. | 12123 | [@bytedance](https://github.com/bytedance) (bytedance) |
| [github-mcp-server](https://github.com/github/github-mcp-server) | GitHub's official MCP Server | 11856 | [@github](https://github.com/github) (github) |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) | Playwright MCP server | 8604 | [@microsoft](https://github.com/microsoft) (microsoft) |
...
| [fastmcp](https://github.com/jlowin/fastmcp) | 🚀 The fast, Pythonic way to build MCP servers and clients | 6765 | [@jlowin](https://github.com/jlowin) |
| [Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP) | MCP server to provide Figma layout information to AI coding agents like Cursor | 5617 | [@GLips](https://github.com/GLips) |
...
| [fastapi_mcp](https://github.com/tadata-org/fastapi_mcp) | A zero-configuration tool for automatically exposing FastAPI endpoints as Model Context Protocol (MCP) tools. | 3525 | [@tadata-org](https://github.com/tadata-org) (tadata-org) |
...
| [mcp](https://github.com/awslabs/mcp) | AWS MCP Servers — specialized MCP servers that bring AWS best practices directly to your development workflow | 2323 | [@awslabs](https://github.com/awslabs) (awslabs) |
| [mcp-use](https://github.com/pietrozullo/mcp-use) | mcp-use is the easiest way to interact with mcp servers with custom agents | 2105 | [@pietrozullo](https://github.com/pietrozullo) |
...
| [context7](https://github.com/upstash/context7) | Context7 MCP Server -- Up-to-date documentation for LLMs and AI code editors | 1137 | [@upstash](https://github.com/upstash) (upstash) |
...
| [mcp-atlassian](https://github.com/sooperset/mcp-atlassian) | MCP server for Atlassian tools (Confluence, Jira) | 1031 | [@sooperset](https://github.com/sooperset) |
...
| [XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP) | A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients. | 307 | [@cameroncooke](https://github.com/cameroncooke) |
